...
| **Sustina** | [sustina-nrgpix](https://github.com/sustina-nrgpix) |[https://sustina.nrgpix.com](https://sustina.nrgpix.com)| ESG and sustainability reporting for business — one governed data foundation, audited Scope 1, 2 and 3 disclosure delivered as a service |Sponsor opportunities live|
| **WM-OS** | [wm-os-com](https://github.com/wm-os-com) |[https://www.wm-os-com](https://www.wm-os.com)| Continuous political analysis and lobbying monitoring — the public record of Parliament turned into decision-ready intelligence |CHRYSALIS |
| **OPED** | [oped-wm-os](https://github.com/oped-wm-os) |[https://oped.wm-os.com](https://oped.wm-os.com)| A knowledge base and analysis of the debate shaping political policy and decision-making globally |BLOOMING|
| **MedTec Compliance** | [MedTec-Compliance](https://github.com/MedTec-Compliance) |[https://precmed.nrgpix.com](https://precmed.nrgpix.com)| Medical-technology regulatory compliance and clinical knowledge, backed by an on-premise, cited-source assistant |BLOOMING |
| **Large Loss Adjustment** | [LargeLoss](https://github.com/LargeLoss) |---| Knowledge and predictive models for major marine, mining and insurance losses |CHRYSALIS |
